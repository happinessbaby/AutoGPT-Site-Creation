...
from customize_document import create_personal_statement_writer_tool, document_customize_writer
from langchain.agents.agent_toolkits import create_conversational_retrieval_agent
...
class ChatController():
    ...
    def _initialize_chat_agent(self) -> None:
        ...
        self.tools =  cover_letter_tool + resume_evaluator_tool + search_tool + wiki_tool + link_download_tool  + general_tool + document_customize_tool + interview_material_tool
